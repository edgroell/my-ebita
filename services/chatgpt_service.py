    ...
    def analyze_transcript(
        ...
        try:
            ...
            try:
                ...
                model_used = getattr(completion, "model", None)
                temperature_used = getattr(completion, "temperature", None)
            ...
            try:
                analysis_result = analysis_result_cls(
                    structured_output=analysis_content,
                    request_time_ms=request_elapsed,
                    model=model_used or "",
                    temperature=(float(temperature_used) if temperature_used is not None else float(temp_param)),
